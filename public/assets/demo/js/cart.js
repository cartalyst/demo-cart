...
$(document).on('click', '.btn-add', function (e) {
    ...
    $.ajax({
        ...
        self.attr('href', 'demo/cart/' + res.rowId + '/remove');
...
$(document).on('click', '.wishlist-add', function (e) {
    ...
    $.ajax({
        ...
        self.attr('href', 'demo/wishlist/' + res.rowId + '/remove');
...
$(document).on('click', '.btn-remove', function (e) {
    ...
    $.ajax({
        ...
        if (res.message === 'success') {
            ...
            self.attr('href', 'demo/cart/' + res.id + '/add');
...
$(document).on('click', '.wishlist-remove', function (e) {
    ...
    $.ajax({
        ...
        if (res.message === 'success') {
            ...
            self.attr('href', 'demo/wishlist/' + res.id + '/add');
