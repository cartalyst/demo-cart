...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="table-responsive">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-danger btn-xs" href="{{ route('cart.remove-item', [ $item->get('rowId') ]) }}">Delete</a>
                                <a class="btn btn-info btn-xs" href="{{ route('cart.move-item', [ $item->get('rowId') ]) }}">To Wishlist</a>
                            </td>
                        </tr>
                        @endforeach
                        <tr>
                        ...
                        <tr class="success">
                            <td colspan="4">
                                <a href="{{ route('coupon.remove', [ $condition->get('name') ]) }}" class="pull-left label label-danger"><i class="fa fa-trash-o"></i></a>
            ...
            <br />
            <form role="form" method="post" action="{{ route('coupon.apply') }}">
